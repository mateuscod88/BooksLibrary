...
namespace BooksLibrary.Infrastructure.Persistance;
...
public class AppDbContext(DbContextOptions options) : DbContext(options), IAppDbContext
{
    ...
    {
        foreach (var entry in ChangeTracker.Entries<Book>().Where(e => e.State == EntityState.Deleted))
        {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        new Book { Id = 12, Title = "Szpital Przemienienia", Author = "Stanisław Lem", Isbn = "978-8378931201" },
        ...
        new Book { Id = 19, Title = "Wiedźmin: Ostatnie Życzenie", Author = "Andrzej Sapkowski", Isbn = "978-8375780642" },
        new Book { Id = 20, Title = "Wiedźmin: Miecz Przeznaczenia", Author = "Andrzej Sapkowski", Isbn = "978-8375780659" },
        new Book { Id = 21, Title = "Wiedźmin: Krew Elfów", Author = "Andrzej Sapkowski", Isbn = "978-8375780666" },
        new Book { Id = 22, Title = "Wiedźmin: Czas Pogardy", Author = "Andrzej Sapkowski", Isbn = "978-8375780673" },
        new Book { Id = 23, Title = "Wiedźmin: Chrzest Ognia", Author = "Andrzej Sapkowski", Isbn = "978-8375780680" },
        new Book { Id = 24, Title = "Wiedźmin: Wieża Jaskółki", Author = "Andrzej Sapkowski", Isbn = "978-8375780697" },
        new Book { Id = 25, Title = "Wiedźmin: Pani Jeziora", Author = "Andrzej Sapkowski", Isbn = "978-8375780703" },
        ...
        new Book { Id = 28, Title = "Władca Pierścieni: Drużyna Pierścienia", Author = "J.R.R. Tolkien", Isbn = "978-8375068253" },
        new Book { Id = 29, Title = "Władca Pierścieni: Dwie Wieże", Author = "J.R.R. Tolkien", Isbn = "978-8375068260" },
        new Book { Id = 30, Title = "Władca Pierścieni: Powrót Króla", Author = "J.R.R. Tolkien", Isbn = "978-8375068277" },
        new Book { Id = 31, Title = "Opowieść wigilijna", Author = "Charles Dickens", Isbn = "978-8375068284" },
        new Book { Id = 32, Title = "Mały Książę", Author = "Antoine de Saint-Exupéry", Isbn = "978-8375068291" },
        ...
        new Book { Id = 38, Title = "Mistrz i Małgorzata", Author = "Michaił Bułhakow", Isbn = "978-8375068352" },
